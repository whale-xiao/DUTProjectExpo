...
- **现行设计/运行基准**：`03-数据库设计.md`（9 表）、`04-UML设计.md`（接口已同步实现）、`06-环境配置.md`（V2.0）、`09-前台设计方案.md`、`10-调用链设计.md`、`UI设计和性能优化.md`。
- **课程交付物（模板/台账）**：`需求变更记录.md`（RTM 变更台账）、`界面功能点与分工矩阵.md`（大/中/小分类 + 担当者/责任者=组长 肖文浩）。
- **旧版已在文件顶部标注"已被取代 · 仅供历史参考"**：`02-基本架构.md`、`03-数据流.md`、`04-数据库设计.md`、`05-UI设计.md`、`08-前端设计方案.md`（其 §3 设计令牌已被 `tokens.css` 落地，仍可参考）。
- `01-需求分析.md` 为用户维护的课程评审版；`00-README.md` 为最新索引。
